...
Owl is a Haskell package, built with [cabal](https://www.haskell.org/cabal/). Run `cabal run owl` to see options for the executable. If developing a protocol, the most useful option is `--log-typecheck`:
